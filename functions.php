...
function load_scripts() {
  ...
  if(!is_admin()){
    wp_enqueue_script('page', get_template_directory_uri().'/assets/js/page.js', false, '5.2.0', 'all');
    wp_enqueue_script('javascript', get_template_directory_uri().'/assets/js/header.js', false, '5.2.0', 'all');
